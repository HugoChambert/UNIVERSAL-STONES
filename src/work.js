...
const interiorImages = [
  `${baseUrl}pic/Interior/1.jpg`,
  `${baseUrl}pic/Interior/2.jpg`,
  `${baseUrl}pic/Interior/3.jpg`,
  `${baseUrl}pic/Interior/4.jpg`,
  `${baseUrl}pic/Interior/5.webp`,
  `${baseUrl}pic/Interior/6.jpg`,
  `${baseUrl}pic/Interior/7.jpg`,
  `${baseUrl}pic/Interior/8.jpg`,
  `${baseUrl}pic/Interior/9.jpg`,
  `${baseUrl}pic/Interior/10.webp`
];

const notableProjects = [
  {
    name: 'Annex',
    image: `${baseUrl}pic/Exterior/Annex Exterior.jpeg`,
  ...
  {
    name: 'Boro',
    image: `${baseUrl}pic/Exterior/Boro.jpg`,
  ...
  {
    name: 'Millcreek',
    image: `${baseUrl}pic/Exterior/Millcreek Exterior 2.jpg`,
  ...
  {
    name: 'Old Georgetown',
    image: `${baseUrl}pic/Exterior/Old Georgetown Exterior.jpeg`,
  ...
  {
    name: 'Parcel 8',
    image: `${baseUrl}pic/Exterior/PARCEL8.jpg`,
  ...
  {
    name: 'The Wharf',
    image: `${baseUrl}pic/Exterior/warf.jpg`,
